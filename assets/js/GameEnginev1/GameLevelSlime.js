...
// Exported from GameBuilder on 2026-03-06T22:46:53.700Z
// How to use this file:
// 1) Save as assets/js/adventureGame/GameLevelAbcd.js in your repo.
// 2) Reference it in your runner or level selector. Examples:
//    import GameLevelPlanets from '/assets/js/GameEnginev1/GameLevelPlanets.js';
//    import GameLevelAbcd from '/assets/js/adventureGame/GameLevelAbcd.js';
//    export const gameLevelClasses = [GameLevelPlanets, GameLevelAbcd];
...
class GameLevelSlime {
    constructor(gameEnv) {
        ...
        const bgData = {
            name: "custom_bg",
            src: path + "/images/gamify/bg/gameart.png",
